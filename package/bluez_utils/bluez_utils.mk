...
BLUEZ_UTILS_DEPENDENCIES = dbus libglib2 libical udev readline
BLUEZ_UTILS_CONF_OPT = --enable-test --enable-tools --disable-systemd --enable-datafiles --enable-experimental
